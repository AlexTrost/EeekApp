class User < ActiveRecord::Base
  ...
  def complimentary_goodstuff
    ...
    Upload.create(user_id: self.id, name:"on the house", text: "Take a deep breath for every red thing you see in the room.", complimentary: "true")
    Upload.create(user_id: self.id, name:"on the house", text: "Breath in for 4 seconds, breath out for 4 seconds. Then breath in for 5 seconds, breath out for 5 seconds. Keep repeating. Add a second each time until you can't anymore.", complimentary: "true")
